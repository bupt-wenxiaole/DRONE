...
func (m *SimMessageStruct) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PatternId) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintWorkerService(dAtA, i, uint64(len(m.PatternId)))
		i += copy(dAtA[i:], m.PatternId)
	}
	if len(m.DataId) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintWorkerService(dAtA, i, uint64(len(m.DataId)))
...
func (m *SimMessageStruct) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.PatternId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
var fileDescriptorWorkerService = []byte{
	...
	,
}
