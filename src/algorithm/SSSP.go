...
func SSSP_PEVal(g graph.Graph, distance map[int64]float64, startID int64, updateMaster map[int64]bool, updateMirror map[int64]bool, visited Set.Set) (bool, map[int][]*Pair, float64, float64, int64, int32, int32) {
...
func SSSP_IncEval(g graph.Graph, distance map[int64]float64, updated []*Pair, updateMaster map[int64]bool, updateMirror map[int64]bool, updatedByMessage map[int64]bool, visited Set.Set, id int) (bool, map[int][]*Pair, float64, float64, int64, int32, int32, float64, int32, int32) {
